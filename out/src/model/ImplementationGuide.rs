...
impl ImplementationGuideLicense {
    pub fn from_string(string: &str) -> Option<ImplementationGuideLicense> {
      match string {
        ...
        "BSD-3-Clause-No-Nuclear-License-2014" => Some(ImplementationGuideLicense::Bsd3ClauseNoNuclearLicense2014),
        "BSD-3-Clause-No-Nuclear-License" => Some(ImplementationGuideLicense::Bsd3ClauseNoNuclearLicense),
        "BSD-3-Clause-No-Nuclear-Warranty" => Some(ImplementationGuideLicense::Bsd3ClauseNoNuclearWarranty),
        ...
        "CNRI-Python-GPL-Compatible" => Some(ImplementationGuideLicense::CnriPythonGplCompatible),
        ...
        "MPL-2.0-no-copyleft-exception" => Some(ImplementationGuideLicense::Mpl20NoCopyleftException),
