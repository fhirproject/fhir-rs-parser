...
impl MedicationKnowledge<'_> {
  ...
  pub fn preparation_instruction(&self) -> Option<String> {
  ...
  pub fn cost(&self) -> Option<Vec<MedicationKnowledge_Cost>> {
    if let Some(Value::Array(val)) = self.value.get("cost") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_Cost { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn kinetics(&self) -> Option<Vec<MedicationKnowledge_Kinetics>> {
    if let Some(Value::Array(val)) = self.value.get("kinetics") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_Kinetics { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn regulatory(&self) -> Option<Vec<MedicationKnowledge_Regulatory>> {
    if let Some(Value::Array(val)) = self.value.get("regulatory") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_Regulatory { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn medicine_classification(&self) -> Option<Vec<MedicationKnowledge_MedicineClassification>> {
    if let Some(Value::Array(val)) = self.value.get("medicineClassification") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_MedicineClassification { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn administration_guidelines(&self) -> Option<Vec<MedicationKnowledge_AdministrationGuidelines>> {
    if let Some(Value::Array(val)) = self.value.get("administrationGuidelines") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_AdministrationGuidelines { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn monograph(&self) -> Option<Vec<MedicationKnowledge_Monograph>> {
    if let Some(Value::Array(val)) = self.value.get("monograph") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_Monograph { value: e }).collect::<Vec<_>>());
    }
    return None;
  }

  /// Associated or related knowledge about a medication.
  pub fn related_medication_knowledge(&self) -> Option<Vec<MedicationKnowledge_RelatedMedicationKnowledge>> {
    if let Some(Value::Array(val)) = self.value.get("relatedMedicationKnowledge") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_RelatedMedicationKnowledge { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn drug_characteristic(&self) -> Option<Vec<MedicationKnowledge_DrugCharacteristic>> {
    if let Some(Value::Array(val)) = self.value.get("drugCharacteristic") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_DrugCharacteristic { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn synonym(&self) -> Option<Vec<String>> {
  ...
  pub fn ingredient(&self) -> Option<Vec<MedicationKnowledge_Ingredient>> {
    if let Some(Value::Array(val)) = self.value.get("ingredient") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_Ingredient { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn monitoring_program(&self) -> Option<Vec<MedicationKnowledge_MonitoringProgram>> {
    if let Some(Value::Array(val)) = self.value.get("monitoringProgram") {
      return Some(val.into_iter().map(|e| MedicationKnowledge_MonitoringProgram { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
