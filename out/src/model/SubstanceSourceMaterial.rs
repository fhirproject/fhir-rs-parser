...
impl SubstanceSourceMaterial<'_> {
  ...
  pub fn fraction_description(&self) -> Option<Vec<SubstanceSourceMaterial_FractionDescription>> {
    if let Some(Value::Array(val)) = self.value.get("fractionDescription") {
      return Some(val.into_iter().map(|e| SubstanceSourceMaterial_FractionDescription { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn part_description(&self) -> Option<Vec<SubstanceSourceMaterial_PartDescription>> {
    if let Some(Value::Array(val)) = self.value.get("partDescription") {
      return Some(val.into_iter().map(|e| SubstanceSourceMaterial_PartDescription { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn geographical_location(&self) -> Option<Vec<String>> {
  ...
  /// taxonomy.
  pub fn organism_name(&self) -> Option<String> {
  ...
  pub fn parent_substance_name(&self) -> Option<Vec<String>> {
