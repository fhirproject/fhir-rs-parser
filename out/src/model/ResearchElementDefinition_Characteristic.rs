...
impl ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure {
    pub fn from_string(string: &str) -> Option<ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure> {
      match string {
        "mean" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::Mean),
        "median" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::Median),
        "mean-of-mean" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::MeanOfMean),
        "mean-of-median" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::MeanOfMedian),
        "median-of-mean" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::MedianOfMean),
        "median-of-median" => Some(ResearchElementDefinition_CharacteristicStudyEffectiveGroupMeasure::MedianOfMedian),
        _ => None,
    }
  }
}
...
impl ResearchElementDefinition_CharacteristicParticipantEffectiveGroupMeasure {
    pub fn from_string(string: &str) -> Option<ResearchElementDefinition_CharacteristicParticipantEffectiveGroupMeasure> {
      match string {
