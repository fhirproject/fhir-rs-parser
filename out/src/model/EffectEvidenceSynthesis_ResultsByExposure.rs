...
impl EffectEvidenceSynthesis_ResultsByExposureExposureState {
    pub fn from_string(string: &str) -> Option<EffectEvidenceSynthesis_ResultsByExposureExposureState> {
      match string {
        "exposure" => Some(EffectEvidenceSynthesis_ResultsByExposureExposureState::Exposure),
        "exposure-alternative" => Some(EffectEvidenceSynthesis_ResultsByExposureExposureState::ExposureAlternative),
        _ => None,
    }
  }
}
