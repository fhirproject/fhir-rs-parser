...
pub struct MolecularSequence {
  ...
  structure_variant: Vec<MolecularSequence_StructureVariant>,
  ...
  /// 6)).
  quality: Vec<MolecularSequence_Quality>,

  /// Pointer to next atomic sequence which at most contains one variant.
  pointer: Vec<Box<Reference>>,
  ...
  repository: Vec<MolecularSequence_Repository>,
  ...
  variant: Vec<MolecularSequence_Variant>,

  /// Amino Acid Sequence/ DNA Sequence / RNA Sequence.
  #[serde(rename = "type")]
  fhir_type: MolecularSequenceType,
