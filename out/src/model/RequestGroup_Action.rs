...
impl RequestGroup_Action<'_> {
  ...
  pub fn selection_behavior(&self) -> Option<String> {
  ...
  pub fn required_behavior(&self) -> Option<String> {
  ...
  pub fn grouping_behavior(&self) -> Option<String> {
  ...
  pub fn precheck_behavior(&self) -> Option<String> {
  ...
  pub fn cardinality_behavior(&self) -> Option<String> {
  ...
  pub fn condition(&self) -> Option<Vec<RequestGroup_Condition>> {
    if let Some(Value::Array(val)) = self.value.get("condition") {
      return Some(val.into_iter().map(|e| RequestGroup_Condition { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn related_action(&self) -> Option<Vec<RequestGroup_RelatedAction>> {
    if let Some(Value::Array(val)) = self.value.get("relatedAction") {
      return Some(val.into_iter().map(|e| RequestGroup_RelatedAction { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
  ...
  pub fn action(&self) -> Option<Vec<RequestGroup_Action>> {
    if let Some(Value::Array(val)) = self.value.get("action") {
      return Some(val.into_iter().map(|e| RequestGroup_Action { value: e }).collect::<Vec<_>>());
    }
    return None;
  }
