...
pub struct GuidanceResponse {
  ...
  module_codeable_concept: CodeableConcept,
  ...
  output_parameters: Box<Reference>,
  ...
  evaluation_message: Vec<Box<Reference>>,
