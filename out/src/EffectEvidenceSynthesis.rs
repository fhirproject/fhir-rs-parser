...
struct EffectEvidenceSynthesis {
  ...
  effect_estimate: Vec<EffectEvidenceSynthesis_EffectEstimate>,

  /// A description of the certainty of the effect estimate.
  certainty: Vec<EffectEvidenceSynthesis_Certainty>,
  ...
  results_by_exposure: Vec<EffectEvidenceSynthesis_ResultsByExposure>,
